...
import tfar.erogare.network.client.S2CModPacket;
import tfar.erogare.network.server.C2SModPacket;
...
public class PacketHandlerForge {
    ...
    public static SimpleChannel INSTANCE =  NetworkRegistry.newSimpleChannel(Erogare.id("packet"), () -> "1.0", s -> true, s -> true);
